...
<head>
    ...
    <link th:href="@{/font-awesome/css/fon t-awesome.css}" rel="stylesheet" />
    ...
    <!-- Page-Level CSS -->
    <link th:href="@{/plugins/morris/morris-0.4.3.min.css}" rel="stylesheet" />
   </head>
 <body>
    <!--  wrapper -->
    <div id="wrapper">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="/login"><i class="fa fa-user fa-fw"></i>User Profile</a>
                        </li>
 ...
 <i class="fa  fa-pencil"></i><b>&nbsp;2,000 </b>Support Tickets Pending to Answere. nbsp;
    ...
    <script th:src="@{/plugins/pace/pace.js}"></script>
    <script th:src="@{/scripts/siminta.js}"></script>
    <!-- Page-Level Plugin Scripts-->
    <script th:src="@{/plugins/morris/raphael-2.1.0.min.js}"></script>
    <script th:src="@{/plugins/morris/morris.js}"></script>
    <script th:src="@{/scripts/dashboard-demo.js}"></script>
